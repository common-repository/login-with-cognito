<?php
/**
 * MoCognito_Admin_Addons Class Doc Comment
 *
 * @package    Admin\Addons
...
class MoCognito_Admin_Addons {
	...
	public static $all_addons = array(
		...
		array(
			...
			'desc'  => 'Supported 2FA methods:- Google Authenticator, OTP Over SMS, OTP Over Email, Email Verification, miniOrange methods. Additional Features:- Unlimited Users & Multisite support,Website Security features',
			'img'   => 'images/fsso.png',
		...
		array(
			...
			'desc'  => 'Allows to map the SSO users to MemberPress Membership levels as per the attributes sent by your OAuth/OpenId Identity Provider.',
	...
	public const RECOMMENDED_ADDONS_PATH = array(
...
<input type="hidden" value="<?php echo esc_attr( mocognito_is_customer_registered() ); ?>" id="mo_customer_registered_addon">

<a	id="mobacktoaccountsetup_addon" style="display:none;" href="<?php echo esc_url( add_query_arg( array( 'tab' => 'account' ), isset( $_SERVER['REQUEST_URI'] ) ? sanitize_text_field( wp_unslash( $_SERVER['REQUEST_URI'] ) ) : '' ) ); ?>">Back</a>
...
<script type="text/javascript">
	...
	/**
	 * Get single addon card
	 *
	 * @param Tag $tag for addon.
	 */
	public static function get_single_addon_cardt( $tag ) {
		...
		<div class="mo_float-child2">
			<div><strong><p style="font-size: 20px;margin: 1px;padding-left: 7px;line-height: 120%;font-weight: 600;font-family: Verdana, Arial, Helvetica, sans-serif;" ><a href= "<?php echo isset( $addon['link'] ) ? esc_attr( $addon['link'] ) : ''; ?>" target="_blank"><?php echo esc_attr( $addon['title'] ); ?></a></p></strong></div>
			</div>
		</div>
