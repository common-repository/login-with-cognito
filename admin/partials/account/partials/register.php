 ...
 */
function mocognito_register_ui() {
 ...
 * @link       https://miniorange.com
 */
function mocognito_show_customer_info() {
	?>
	<div class="mo_table_layout" >
	...
	<a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'licensing' ), isset( $_SERVER['REQUEST_URI'] ) ? sanitize_text_field( wp_unslash( $_SERVER['REQUEST_URI'] ) ) : '' ) ); ?>"><input type="button" class="button button-primary button-large" value="Check Licensing Plans"/></a>
	</td>
	</tr>
	</table>
	<br />
